  ...
  <section class="hero" aria-label="Apresentação">
    ...
    <div class="container hero__container">
      ...
      <div class="hero__content">
        <p class="label hero__label reveal">Advogado Trabalhista em São Paulo</p>
      ...
      <div class="hero__photo-wrap reveal reveal--delay-2">
        ...
        <img
          ...
          alt="Trabalhador segurando carteira de trabalho — Advocacia Valadão, São Paulo"
          class="hero__photo"
          width="560"
          height="420"
          loading="eager"
        ...
        <div class="hero__urgency-chip">
          ...
          Prazo de 2 anos após a demissão
        </div>
        <!-- OAB badge -->
